create or replace view sicl.vw_mcg_income_mdy
as
...
--            )) "PREMIUM", 
    ...
    from pol_data x where pol_prd_code in ('MCG','MIT') and pol_policy_no like '%MDY%' and pol_sum_insured <= 75000000
    )
    union
    (
    select 
...
--            )) "PREMIUM", 
    ...
    from pol_data x where pol_prd_code in ('MCG','MIT') and pol_policy_no like '%MDY%' and pol_sum_insured > 75000000 and pol_sum_insured < 300000000
    )
    union
    (
    select 
...
--            )) "PREMIUM", 
    ...
    from pol_data x where pol_prd_code in ('MCG','MIT') and pol_policy_no like '%MDY%' and pol_sum_insured > 300000000 and pol_sum_insured < 1000000000
    )
    union
    (
    select 
...
--            )) "PREMIUM", 
    ...
    from pol_data x where pol_prd_code in ('MCG','MIT') and pol_policy_no like '%MDY%' and pol_sum_insured > 1000000000
    )
) xyz;