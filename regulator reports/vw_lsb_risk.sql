select
    ...
    (select distinct(info_value) from pol_risk_info where pol_policy_no = x.pol_policy_no and prs_seq_no=x.prs_seq_no and prs_name = x.prs_name and pin_description = 'INSURED NRC NO') "INSURED NRC NO",
...
from pol_risk_info x where pol_prd_code='LSB';