select
    ...
    (select case pol_bss_bss_code when 'DIRE' then 'DIRECT' else pol_bss_bss_code end "M_TYPE" from pol_data where pol_policy_no = x.pol_policy_no) "MARKETER_TYPE", 
